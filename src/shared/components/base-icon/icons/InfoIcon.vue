<template>
  <svg width="20" height="20" viewBox="0 0 20 20" fill="none" xmlns="http://www.w3.org/2000/svg">
    ...
    <path d="M10 13.3333V10" stroke-width="1.68" stroke-linecap="round" stroke-linejoin="round"/>
    <path d="M10 6.66675H10.0083" stroke-width="1.68" stroke-linecap="round" stroke-linejoin="round"/>
  </svg>
</template>
